...
namespace SacramentPlanner.Controllers
{
    public class HymnsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("HymnID,HymnTitle,HymnType,HymnNumber")] Hymn hymn)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HymnID,HymnTitle,HymnType,HymnNumber")] Hymn hymn)
        {
            if (id != hymn.HymnID)
            {
                return NotFound();
